...
public abstract class Chart {
	...
	protected static void updateSeries(XYChart chart, String name, double[] X, double[] Y, Marker marker, Color color) {
		updateSeries(chart, name, X, Y, marker, color, null);
	}

	protected static void updateSeries(XYChart chart, String name, double[] X, double[] Y, Marker marker, Color color, BasicStroke stroke) {
